...
//animation for tooltips
	...
	initialization: function(){
		...
		$('#'+self.options.pictures).bind('mouseout', function() {
		...
		if(self.options.animation){
		 ...
		 //$("#"+self.options.annotationData).val('animation: true, animationType: "'+self.options.animationType+'", animationBg: "'+self.options.animationBg+'", button: "'+self.options.button+'", '+moreInfos);
                 $("#"+self.options.annotationData).val('animation: true, animationType: "'+self.options.animationType+'", pictures:["'+self.options.pictures+'"], animationBg: "'+self.options.animationBg+'", button: "'+self.options.button+'", '+moreInfos);
		}
                else{
		  //console.log('animation: false, button: "'+self.options.button+'", '+moreInfos);
		}
		});
	},
